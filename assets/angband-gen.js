...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'stage/angband-gen.data';
      var REMOTE_PACKAGE_BASE = 'angband-gen.data';
...
Module['FS_createPath']("/lib", "file", true, true);
Module['FS_createPath']("/lib", "xtra", true, true);
Module['FS_createPath']("/lib/xtra", "graf", true, true);
Module['FS_createPath']("/lib", "user", true, true);
Module['FS_createPath']("/lib", "edit", true, true);
Module['FS_createPath']("/lib", "help", true, true);
Module['FS_createPath']("/lib", "pref", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_stage/angband-gen.data');

      };
      Module['addRunDependency']('datafile_stage/angband-gen.data');
...
var wasmBinaryFile;
  wasmBinaryFile = 'angband-gen.wasm';
...
var ASM_CONSTS = {
  206134: function() {ANGBAND.initializeFilesystem();},  
 206170: function($0, $1, $2, $3) {ANGBAND.setCell($0, $1, $2, $3);},  
 206207: function($0, $1, $2, $3, $4, $5, $6) {ANGBAND.setCellPict($0, $1, $2, $3, $4, $5, $6);},  
 206260: function($0, $1, $2) {ANGBAND.wipeCells($0, $1, $2);},  
 206295: function($0, $1, $2) {ANGBAND.setCursor($0, $1, $2);},  
 206330: function() {ANGBAND.clearScreen();},  
 206357: function() {ANGBAND.flushDrawing();},  
 206385: function() {return ANGBAND.eventKeyCode();},  
 206420: function() {return ANGBAND.eventModifiers();},  
 206457: function() {ANGBAND.popEvent();},  
 206481: function() {return ANGBAND.checkActivateBorg();},  
 206521: function() {return ANGBAND.desiredGraphicsMode;}
};
function __asyncjs__emscripten_gather_event(wait){ return Asyncify.handleAsync(async () => { return ANGBAND.gatherEvent(wait); }); }
function emscripten_file_sync(){ ANGBAND.fsync(); }
function emscripten_has_event(){ return ANGBAND.hasEvent(); }
function emscripten_quit_with_great_force(){ ANGBAND.quitWithGreatForce(); }
function emscripten_turbo(){ return ANGBAND.turbo; }
...
var asmLibraryArg = {
  ...
  "__asyncjs__emscripten_gather_event": __asyncjs__emscripten_gather_event,
  ...
  "emscripten_file_sync": emscripten_file_sync,
  "emscripten_has_event": emscripten_has_event,
  "emscripten_memcpy_big": _emscripten_memcpy_big,
  "emscripten_quit_with_great_force": emscripten_quit_with_great_force,
  "emscripten_resize_heap": _emscripten_resize_heap,
  "emscripten_sleep": _emscripten_sleep,
  "emscripten_turbo": emscripten_turbo,
